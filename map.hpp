...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/29 15:43:50 by celys             #+#    #+#             */
/*   Updated: 2022/04/29 16:12:39 by celys            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//		BASE
		...
		map(map &other_map) : _alloc(other_map._alloc), _tree(other_map._tree), _compare(other_map._compare) {}
		map& operator= (const map&other_map) 
		{
			_alloc = other_map._alloc;
			_tree = other_map._tree;
			_compare = other_map._compare;
			return *this;
		}
